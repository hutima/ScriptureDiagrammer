...
| I  | Col 2:11-12 two-sided fix | done (4ff5dc7 layout, 74283d1 alternate; 1904 base already draws the relative-clause reading so its alternate would be a no-op) |
